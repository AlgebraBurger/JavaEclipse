			...
			new ToolbarListener(){
				...
				public void saveEventOccured() {
					...
					try {
						...
						JOptionPane.showMessageDialog(MainFrame.this,"Unable to save database.","Database Connection Problem.",JOptionPane.ERROR_MESSAGE);
					}
				...
				public void refreshEventOccured() {
					...
					try {
						...
						JOptionPane.showMessageDialog(MainFrame.this,"Unable to load database.","Database Connection Problem.",JOptionPane.ERROR_MESSAGE);
					}
